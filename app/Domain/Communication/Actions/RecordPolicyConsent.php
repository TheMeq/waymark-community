...
final class RecordPolicyConsent
{
    ...
    {
        if ($version->publication_state !== 'published' || $version->published_at === null || ! in_array($action, ['newsletter', 'photo_upload', 'terms'], true)) { throw ValidationException::withMessages(['consent' => 'Consent must reference a published relevant policy version.']); }
