...
final class ModeratableCommunityPhotoReports
{
    /** @return Builder<CommunityPhotoReport> */
    public function for(User $actor, array $statuses = ['open']): Builder
    {
        $query = CommunityPhotoReport::query()->with(['photo.event:id,title,organiser_id', 'photo.specialAlbum:id,title', 'reporter:id,name,display_name'])
