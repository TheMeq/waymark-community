...
final class PublicPolicyController
{
    ...
    {
        $page = PolicyPage::query()->with('currentVersion')->where('slug', $slug)->whereNotNull('current_version_id')->firstOrFail(); abort_unless($page->currentVersion?->publication_state === 'published', 404);
