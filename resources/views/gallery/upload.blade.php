...
@section('content')
    <section class="bg-surface-raised py-10 sm:py-14">
        <div class="wm-container max-w-[var(--wm-container-copy)]">
            ...
            @if ($errors->any())<div class="mt-6 rounded-[var(--wm-radius-md)] border border-red-700 bg-surface p-4 text-ink" role="alert" tabindex="-1"><p class="font-semibold">Please review the photo upload.</p><ul class="mt-2 list-inside list-disc">@foreach ($errors->all() as $error)<li>{{ $error }}</li>@endforeach</ul></div>@endif
