...
<main>
    ...
    @else
        <p>This standalone route is for a broken administration area. It replaces the current database and private files, restores application cryptographic identity, and preserves this host's infrastructure settings.</p>
