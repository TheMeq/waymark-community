...
$moderationEvent = Event::query()->create([
    ...
    'starts_at' => CarbonImmutable::parse('2026-08-18 09:30:00'),
    'ends_at' => CarbonImmutable::parse('2026-08-18 15:30:00'),
...
foreach (range(1, 3) as $number) {
    ...
    $reportPhoto = CommunityPhoto::query()->create([
        ...
        'source_path' => $reportPath, 'processed_variants' => ['master' => $reportPath], 'moderation_status' => 'approved', 'caption' => 'Browser report photo '.$number,
    ]);
