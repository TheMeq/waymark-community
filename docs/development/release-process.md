...
7. Only authorised release work after approval may add the dated changelog version, create the public Git tag, sign/publish artifacts and update the stable feed.
