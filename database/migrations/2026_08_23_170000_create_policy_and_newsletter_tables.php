...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('policy_consents', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['user_id', 'policy_version_id', 'action']);
        });
        ...
        Schema::create('newsletters', function (Blueprint $table): void {
            ...
            $table->json('audience_roles');
            $table->json('audience_account_statuses');
            $table->boolean('consent_required')->default(true);
            $table->foreignId('consent_policy_version_id')->nullable()->constrained('policy_versions')->restrictOnDelete();
